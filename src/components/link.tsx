...
export default function Link({
  ...
  switch (variant) {
    case "default":
      ...
      break;
    case "cta":
      className = `relative rounded-full transition bg-primary px-6 py-2 text-center font-bold uppercase text-background shadow-md shadow-black/25 after:absolute after:inset-0 after:rounded-full hover:scale-105 hover:after:bg-white/10 ${className}`;
      break;
    case "button":
